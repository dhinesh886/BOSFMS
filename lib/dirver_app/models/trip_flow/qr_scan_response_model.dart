...
QrScanResponseModel qrScanResponseModelFromJson(String str) =>
    QrScanResponseModel.fromJson(json.decode(str));

String qrScanResponseModelToJson(QrScanResponseModel data) =>
...
class QrScanResponseModel {
  ...
  QrScanResponseModel.fromJson(Map<String, dynamic> json) {
    code = json["code"] ?? "";
    id = json["id"] ?? "";
