...
class MaintenanceScreen extends StatefulWidget {
  final String userId;
  final String token;
  const MaintenanceScreen({Key? key, required this.userId, required this.token})
      : super(key: key);
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (context) => const ServiceRaisedScreen(
              message: "Service request raised\nsuccessfully",
              isTrip: false,
              driverToken: "",
            ),
          ),
          ...
          if (snapshot.hasData) {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                children: [
                  SizedBox(
                    height: size.height - (AppBar().preferredSize.height * 1.2),
                    child: Form(
                      key: formKey,
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                if (odometerReadingController.text == "") {
                                  customErrorToast(
