...
//
//     final getAccessibleServiceRequestResponseModel = getAccessibleServiceRequestResponseModelFromJson(jsonString);

import 'dart:convert';

List<GetAccessibleServiceRequestResponseModel>
    getAccessibleServiceRequestResponseModelFromJson(String str) =>
        List<GetAccessibleServiceRequestResponseModel>.from(json
            .decode(str)
            .map((x) => GetAccessibleServiceRequestResponseModel.fromJson(x)));

String getAccessibleServiceRequestResponseModelToJson(
        List<GetAccessibleServiceRequestResponseModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetAccessibleServiceRequestResponseModel {
  ...
  factory GetAccessibleServiceRequestResponseModel.fromJson(
