...
//
//     final getAccessibleServiceTicketsResponseModel = getAccessibleServiceTicketsResponseModelFromJson(jsonString);

import 'dart:convert';

List<GetAccessibleServiceTicketsResponseModel2>
    getAccessibleServiceTicketsResponseModel2FromJson(String str) =>
        List<GetAccessibleServiceTicketsResponseModel2>.from(json
            .decode(str)
            .map((x) => GetAccessibleServiceTicketsResponseModel2.fromJson(x)));

// String getAccessibleServiceTicketsResponseModelToJson(
//         List<GetAccessibleServiceTicketsResponseModel> data) =>
//     json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetAccessibleServiceTicketsResponseModel2 {
  GetAccessibleServiceTicketsResponseModel2({
    required this.id,
  ...
  factory GetAccessibleServiceTicketsResponseModel2.fromJson(
      ...
      GetAccessibleServiceTicketsResponseModel2(
        ...
        // serviceTicketDetails: List<ServiceTicketDetail>.from(
        //     json["serviceTicketDetails"]
